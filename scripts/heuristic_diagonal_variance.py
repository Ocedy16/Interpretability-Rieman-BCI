...
from src.Shapley.shapley_spd import (
    proj_on_spd, KernelShap, stable_predict, compute_shapley_heuristic,
...
if __name__ == "__main__":
    ...
    if not args.visu_only:
        ...
        for subject in dataset.subject_list :  
            ...
            shap_values, scores = compute_shapley_heuristic(X,y,N_SPLITS, classifier)
        ...
        plot_pannel(all_mean_shap_values,dataset, SENSORS, all_scores, OUT_DIR, suptitle = f'Shapley values on {args.dataset}')
